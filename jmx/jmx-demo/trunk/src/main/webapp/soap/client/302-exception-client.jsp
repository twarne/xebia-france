...
<head>
<title>HelloWorldService expect 302 Exception</title>
</head>
<body>
<h1>HelloWorldService expect 302 Exception</h1>
<%
    ...
    HelloWorldService helloWorldService = (HelloWorldService)applicationContext
        .getBean("helloWorldServiceClient-302Exception");
    try {
        String answer = helloWorldService.sayHi("I expect a 302 Exception");

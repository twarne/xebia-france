        ...
        if (isEnabled()) {
            ...
            if (mbeanServer == null) {
                ...
                if (usePlatformMBeanServer) {
                    ...
                    List<MBeanServer> servers = MBeanServerFactory.findMBeanServer(mbeanServerName);
                    if (servers.size() <= 1) {
                        mbeanServer = MBeanServerFactory.createMBeanServer(mbeanServerName);
                    } else {
            ...
            if (createMBServerConnectorFactory) {
                ...
                mcf.setMBeanServer(mbeanServer);

 ...
 */
public class ServletContext24AwareMBeanServerFactory implements FactoryBean, ServletContextAware, InitializingBean {
    
    private final static Logger logger = Logger.getLogger(ServletContext24AwareMBeanServerFactory.class);

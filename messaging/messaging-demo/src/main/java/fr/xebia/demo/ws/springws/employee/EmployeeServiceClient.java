...
public class EmployeeServiceClient {
    ...
    public void testWsClient() throws Exception {
        ...
        marshaller.setClassesToBeBound(new Class[] {
            Employee.class, Gender.class, EmployeeElement.class
        });
        ...
        Handler handler = new AbstractHandler() {
            ...
            @Override
            public void handle(String path, HttpServletRequest request, HttpServletResponse response, int dispatch) throws IOException,
                ServletException {

...
public class MessageListenerAdapter implements MessageListener, SessionAwareMessageListener {
    ...
    /**
     * Specifies if the request's message id is used as the response's correlation 
     * id. Otherwise, the request's correlation id is used as the response's 
     * correlation id.
     */
     ...
     * to the request message's message id if <code>useMessageIdInResponse</code> 
     * is set to <code>true</code> and the correlation id otherwise.

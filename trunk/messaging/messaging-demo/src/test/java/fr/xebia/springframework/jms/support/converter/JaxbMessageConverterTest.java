...
public class JaxbMessageConverterTest {
    ...
    private JaxbMessageConverter createJaxbMessageConverter(Class<?>... classesToBeBound) throws Exception {
        JaxbMessageConverter jaxbMessageConverter = new JaxbMessageConverter();
        jaxbMessageConverter.setClassesToBeBound(classesToBeBound);
        jaxbMessageConverter.afterPropertiesSet();

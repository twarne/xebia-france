...
public class XmlAwareQueueSenderMqTest extends TestCase {
    ...
    public void testSendXmlMessage() throws Exception {
        ...
        Reader xml = new StringReader("<root><child>Hello Queue éèà with default encoding</child></root>");
    ...
    public void testSendIso88591XmlMessage() throws Exception {
        ...
        Reader xml = new StringReader("<root><child>Hello Queue éèà with ISO-8859-1 encoding</child></root>");
        xmlMessage.setSource(new StreamSource(xml));
    ...
    public void testSendUtf8XmlMessage() throws Exception {
        ...
        Reader xml = new StringReader("<root><child>Hello Queue éèà with UTF-8 encoding</child></root>");
        xmlMessage.setSource(new StreamSource(xml));

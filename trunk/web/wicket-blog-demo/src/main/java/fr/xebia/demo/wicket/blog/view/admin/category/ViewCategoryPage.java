...
public class ViewCategoryPage extends CategoryPage {

    private static final long serialVersionUID = 1L;

    public ViewCategoryPage(PageParameters pageParameters) {
    ...
    protected void createComponents(Category category) {
        ...
        add(new Label("nicename", String.valueOf(category.getNicename())));
